...
public final class ActivityMainBinding implements ViewBinding {
  ...
  private ActivityMainBinding(@NonNull CoordinatorLayout rootView, @NonNull Button btnSpk,
      @NonNull Button btnclose, @NonNull FragmentContainerView fragmentContainer,
  ...
  public static ActivityMainBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      id = R.id.btnSpk;
      Button btnSpk = ViewBindings.findChildViewById(rootView, id);
      if (btnSpk == null) {
        break missingId;
      }
      ...
      return new ActivityMainBinding((CoordinatorLayout) rootView, btnSpk, btnclose,
